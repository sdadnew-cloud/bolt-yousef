...
export default function ThemeDesigner() {
  ...
  const resetToDefault = () => {
    if (window.confirm('Are you sure you want to reset to default theme?')) {
      ...
      setCustomColors(Object.fromEntries(
        Object.entries(defaultDesignScheme.palette).map(([key, value]) => [key, value])
      ));
                ...
                >
                  <div>
                    <div 
                      ...
                      style={{ fontFamily: font.key === 'sans-serif' ? 'ui-sans-serif, system-ui, sans-serif' :
                               font.key === 'serif' ? 'ui-serif, Georgia, serif' :
                               font.key === 'monospace' ? 'ui-monospace, SFMono-Regular, Monaco, Consolas' :
                               font.key === 'cursive' ? 'ui-script, cursive' : 'default' }}
                    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div
            className={`rounded-lg p-4 border ${
              designScheme.features.includes('rounded') ? 'rounded-lg' : ''
            } ${
          ...
          >
            <h4
              ...
              style={{ color: designScheme.palette.primary || '#9E7FFF' }}
            >
              Sample Card
            </h4>
            <p
              className="text-sm"
              style={{ color: designScheme.palette.textSecondary || '#A3A3A3' }}
            >
            ...
            <div className="flex gap-2 mt-3">
              <button
                className={`px-3 py-1.5 text-sm rounded ${
                  designScheme.features.includes('rounded') ? 'rounded' : ''
                }`}
                style={{
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4
                ...
                style={{ color: designScheme.palette.text || '#FFFFFF' }}
              >
                Status Card
              </h4>
            </div>
          ...
          >
            <h4
              className="font-medium mb-2"
              style={{ color: designScheme.palette.accent || '#f472b6' }}
            >
              Accent Card
            </h4>
